<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(item,index) in userAddress" :key="item.id">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{isDefaults.fullAddress}}</span>
        收货人：<span>{{isDefaults.consignee}}</span>
        <span>{{isDefaults.phoneNum}}</span>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    mounted(){
      ...
      this.$store.dispatch("trade/tradeList")
    },
    computed:{
      ...mapState("trade",['userAddress','tradeList']),
     isDefaults(){
          if(this.userAddress){
     ...
     async subOrder(){
       ...
       let data={
        "consignee": this.isDefaults.consignee,
        "consigneeTel": this.isDefaults.phoneNum,
        "deliveryAddress": this.isDefaults.fullAddress,
        "paymentWay": "ONLINE",
